import {Box, Text, Input, Heading, Grid, GridItem, InputGroup, InputLeftElement, FormLabel, FormControl} from "@chakra-ui/react";
...
function ContactDetails() {
    ...
    const handleGithubLinkChange = (event) => setGithubLink(event.target.value)
    ...
    return (
        ...
        <Grid templateColumns='repeat(2, 1fr)' gap={4}>
            ...
            <FormLabel mb='8px' textAlign="left">Email: {email}</FormLabel>
            <InputGroup>
            ...
            <FormControl isRequired>
            <FormLabel mb='8px' textAlign="left">Github Link: {githubLink}</FormLabel>
            <InputGroup>
            <InputLeftElement pointerEvents='none'>
            ...
            <Text mb='8px' textAlign="left">Phone: {phone}</Text>
            <InputGroup>
            <InputLeftElement pointerEvents='none'>
            ...
            <GridItem>
            <Box mb="8px">
            <Text mb='8px' textAlign="left">Website: {website}</Text>
            <InputGroup>
            <InputLeftElement pointerEvents='none'>
