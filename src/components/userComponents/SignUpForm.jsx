    ...
    <div className="signup-form">
      ...
      <form onSubmit={handleSubmit}>
        <div className="row">
          <div>
            ...
            <input
              ...
              id="firstName"
              name="firstName"
              className={`input ${errorState.firstName ? "input-error" : ""}`}
        ...
        <p style={{ textAlign: "justify" }}>
          ...
          &nbsp; and to receive email updates on courses, special events and GA
          news. You can change your mind at any time and unsubscribe from GA
          marketing emails by clicking the “unsubscribe” link located at the
          bottom of every marketing email or by emailing
          no.marketing@group-assembly.com
        </p>
